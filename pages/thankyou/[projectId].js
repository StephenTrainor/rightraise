...
export default function ThankYouPage() {
    ...
    useEffect(() => { // wait until website is ready to check for window
        if (typeof window !== "undefined") {
            var Confetti = function() { // confetti.min.js
                var t = function() {
                        return function() {
    ...
    return (
        <Layout>
            <Navbar title="Thank You!" />

            <div className="flex flex-col items-center use-space justify-center">
                <p className="header2 mt-10 centered">We have received your generous donation!</p>

                <div className="light-bg hover:hover-bg button-container2 w-40" id="confetti">
                    <div className="centered">
                        Click Me!
                    </div>
                </div>

                <div className="light-bg hover:hover-bg button-container2 w-40">
                    <Link href={`/donate/${router.query.projectId}`} className="mx-auto">
                        Donate Again
                    </Link>
                </div>
            </div>
